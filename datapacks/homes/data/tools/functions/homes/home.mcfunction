...
execute as @e[type=area_effect_cloud,tag=home,limit=1] at @s run function tools:teleport/teleportentity
tag @s remove tget

execute if score @s homedim matches 0 at @s in minecraft:overworld run tp @s ~ ~1 ~
execute if score @s homedim matches 1 at @s in minecraft:the_nether run tp @s ~ ~1 ~
execute if score @s homedim matches 2 at @s in minecraft:the_end run tp @s ~ ~1 ~
